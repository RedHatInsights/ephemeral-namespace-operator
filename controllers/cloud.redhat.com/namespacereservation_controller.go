...
//+kubebuilder:rbac:groups="operators.coreos.com",resources=operators;events;namespaces;limitranges;resourcequotas,verbs=get;list;watch;create;update;patch;delete
