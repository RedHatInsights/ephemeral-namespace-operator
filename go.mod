...
require (
	github.com/RedHatInsights/clowder v0.52.0
	github.com/RedHatInsights/frontend-operator v0.1.1
...
require (
	...
	github.com/openshift/api v0.0.0-20230105153616-8ac112765edc // indirect
