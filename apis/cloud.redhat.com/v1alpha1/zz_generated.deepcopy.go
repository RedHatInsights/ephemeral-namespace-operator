...
func (in *NamespaceConfig) DeepCopyInto(out *NamespaceConfig) {
	*out = *in
	in.ClowdEnvSpec.DeepCopyInto(&out.ClowdEnvSpec)
	out.FrontendEnvSpec = in.FrontendEnvSpec
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamespacePoolConfig) DeepCopyInto(out *NamespacePoolConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamespacePoolConfig.
func (in *NamespacePoolConfig) DeepCopy() *NamespacePoolConfig {
	if in == nil {
		return nil
	}
	out := new(NamespacePoolConfig)
	in.DeepCopyInto(out)
	return out
}
