...
# cloud.redhat.com/ephemeral-namespace-operator-bundle:$VERSION and cloud.redhat.com/ephemeral-namespace-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= cloud.redhat.com/ephemeral-namespace-operator
...
$(ENVTEST): $(LOCALBIN)
	test -s $(LOCALBIN)/setup-envtest || GOBIN=$(LOCALBIN) go install sigs.k8s.io/controller-runtime/tools/setup-envtest@d0396a3d6f9fb554ef2da382a3d0bf05f7565e65
